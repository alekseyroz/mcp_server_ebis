...
def get_user_lists(list_names: list[str] | None = None) -> dict:
    ...
    return client.get("user/lists", params=params)
...
def logout_users(
    ...
    if user_batch is not None:
        return client.post("user/logout", {"UserBatch": user_batch})
    ...
    return client.post("user/logout", body)
...
def get_user_addupdate_lists(list_names: list[str] | None = None) -> dict:
    ...
    if list_names:
        params["name"] = ",".join(list_names)
    return client.get("user/addupdate/lists", params=params)
...
def add_update_users(
    ...
    """
    if user_batch is not None:
        return client.post("user/addupdate", {"UserBatch": user_batch})
    ...
    return client.post("user/addupdate", body)
...
def get_user_cities_admin_lists(list_names: list[str] | None = None) -> dict:
    ...
    if list_names:
        params["name"] = ",".join(list_names)
    return client.get("user/cities/admin/lists", params=params)
...
def edit_user_cities(
    ...
    """
    if user_batch is not None:
        return client.post("user/cities/admin", {"Mode": mode, "UserBatch": user_batch})
    ...
    return client.post("user/cities/admin", body)
